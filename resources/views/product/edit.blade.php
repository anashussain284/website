        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form method="POST" action="{{ route('products.update') }}" class="form-horizontal"
                              role="form">
                        @csrf
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" name="another_sub_category" required>
                                        ...
                                        @php($array = explode("/", $url))
                                            <option value="{{$another_sub_cat->id}}" <?php if ($another_sub_cat->id == $product->another_sub_category_id) {
    echo "selected";
}
?> >{{$array[3]}}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" type="text" id="form-field-1" value="{{$array[4]}}" placeholder="Product" class="col-xs-10 col-sm-5" required/>
                                </div>
                            </div>
