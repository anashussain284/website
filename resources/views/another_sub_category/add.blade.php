...
@section('title', 'Another-Sub-Category')
@section('content')
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form method="post" action="{{ route('another-sub-categories.store') }}" class="form-horizontal"
                              role="form">
                        @csrf
                        <!-- #section:elements.form -->`
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="sub_category" name="sub_category" required>
                                        ...
                                        @php($array = explode("/", $url))
                                            <option value="{{$sub_category->id}}">{{$array[2]}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" type="text" id="form-field-1" placeholder="Another-Sub-Category" class="col-xs-10 col-sm-5" required/>
                                </div>
                            </div>
